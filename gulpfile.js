...
const paths = {
  ...
  srcScssPart: `${srcFolder}/scss/**/**/*.scss`,
  buildCssFolder: `${buildFolder}/css`,
  srcFullJs: `${srcFolder}/js/**/*.js`,
  srcMainJs: `${srcFolder}/js/bundle.js`,
  buildJsFolder: `${buildFolder}/js`,
  srcPartialsFolder: `${srcFolder}/partials`,
  srcPartFolder: `${srcFolder}/partials/part`,
...
const watchFiles = () => {
  ...
  watch(paths.srcScssPart, styles);
  watch(paths.srcFullJs, scripts);
  watch(`${paths.srcPartialsFolder}/*.html`, htmlInclude);
  watch(`${paths.srcPartFolder}/*.html`, htmlInclude);
